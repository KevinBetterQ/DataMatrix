<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<div class="admin">
				...
				<div class="content">
					...
					<div class="am-g">
						<div class="am-u-md-12">
							<!-- 客流量：动态数据+时间坐标轴 -->
							<div class="card-box">
								<div id="kltrend" style="width: 100%;height: 300px;"></div>
							</div>
						</div>
					</div>
					...
					<div class="am-g">
						<div class="am-u-md-12">
							<!-- 入店量：动态数据+时间坐标轴 -->
							<div class="card-box">
								<div id="rdtrend" style="width: 100%;height: 300px;"></div>
							</div>
						</div>
					</div>
					...
					<div class="am-g">
						<div class="am-u-md-12">
							<!-- 跳出量： 动态数据+时间坐标轴 -->
							<div class="card-box">
								<div id="tctrend" style="width: 100%;height: 300px;"></div>
							</div>
						</div>
					</div>
		...
		<script type="text/javascript" src="../assets/js/charts/flow_real.js"></script>
	</body>

								...
								<div class="am-u-md-6">
									<form class="am-form am-text-sm">
										<div class="am-form-group">
											<div class="am-g">
												<label class="am-u-md-2 am-md-text-right am-padding-left-0" for="doc-ipt-text-1">账号</label>
												<input class="am-u-md-10 form-control" id="doc-ipt-text-1" value="123456">
											</div>
										</div>
										...
										<div class="am-form-group">
											<div class="am-g">
												...
												<input class="am-u-md-10 form-control" id="doc-ipt-email-1" value="10938@qq.com">
											</div>
										</div>
										<div class="am-form-group">
											<div class="am-g">
												<label class="am-u-md-2 am-md-text-right am-padding-left-0" for="doc-ipt-pwd-1">原密码</label>

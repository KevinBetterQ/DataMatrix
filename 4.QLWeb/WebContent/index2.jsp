...
<body>
		...
		<div class="content-page">
			...
			<div class="content">
					...
					<div class="am-u-md-12 ">
						<div class="card-box">
							<div class="form-group">
								...
								<div class="input-group date form_date col-md-6 " data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input2"
				...
				<div class="am-g">
						...
						<div class="card-box">
							...
							<div class="widget-box-2">
								<div class="widget-detail-2">
									<span class="badge  pull-left m-t-20  am-round" style="color: #fff; background: #0e90d2;">83% <i class="zmdi zmdi-trending-up"></i> </span>
									<h2 class="m-b-0"> 301 </h2>
					...
					<div class="am-u-md-3">
						<div class="card-box">
							...
							<div class="widget-box-2">
								<div class="widget-detail-2">
									<span class="badge  pull-left m-t-20  am-round progress-bar-pink" style="color: #fff;">17% <i class="zmdi zmdi-trending-up"></i> </span>
									<h2 class="m-b-0"> 63 </h2>
				...
				<div class="am-g">
					...
					<div class="am-u-md-4">
						<div class="card-box">
							<h4 class="header-title m-t-0">顾客趋势</h4>
						...
						<div class="card-box">
							...
							<div class="inbox-widget nicescroll" style="height: 315px; overflow: hidden; outline: none;" tabindex="5000">
								...
								<a href="#">
									<div class="inbox-item">
										<div class="inbox-item-img"><img src="assets/img/wifi.png" class="img-circle" alt=""></div>
										<p class="inbox-item-author">007db072</p>
										<p class="inbox-item-text">s00:6b:8e:e1:13:50</p>
										<p class="inbox-item-date"></p>
									</div>
								</a>
								...
								<table class="am-table   am-text-nowrap">
									...
									<tbody>
										<tr>
											...
											<td>3</td>
											<td>山东省青岛经济技术开发区</td>
											<td><span class="label label-purple">未选中</span>
										</tr>

										<tr>
											<td>2</td>
											<td>007db072</td>
											<td>00:3a:98:0c:66:40</td>
											<td>3</td>
											<td>山东省青岛经济技术开发区</td>
	...
	<script type="text/javascript" src="assets/js/charts/indexChart2.js"></script>

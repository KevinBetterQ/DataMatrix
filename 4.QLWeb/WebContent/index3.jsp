...
<body>
							...
							<div class="form-group">
								...
								<div class="input-group date form_date col-md-6 " data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input2"
								 data-link-format="yyyy-mm-dd">
									...
									<input class="form-control" size="16" type="text" value="2017-07-04" readonly>
				...
				<div class="am-g">
						...
						<div class="card-box">
							...
							<div class="widget-box-2">
								<div class="widget-detail-2">
									<span class="badge  pull-left m-t-20  am-round" style="color: #fff; background: #0e90d2;">55% <i class="zmdi zmdi-trending-up"></i> </span>
									<h2 class="m-b-0"> 162 </h2>
					...
					<div class="am-u-md-3">
						<div class="card-box">
							...
							<div class="widget-box-2">
								<div class="widget-detail-2">
									<span class="badge  pull-left m-t-20  am-round progress-bar-pink" style="color: #fff;">11% <i class="zmdi zmdi-trending-up"></i> </span>
									<h2 class="m-b-0"> 32 </h2>
	...
	<script type="text/javascript" src="assets/js/charts/indexChart3.js"></script>

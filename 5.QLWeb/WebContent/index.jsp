							...
							<div class="form-group">
								...
								<div class="input-group date form_date col-md-6 " data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input2"
								 data-link-format="yyyy-mm-dd">
									...
									<div class="col-lg-2">
										<a href="index3.jsp"><button class="am-btn am-btn-secondary" type="submit">确定</button></a>
									</div>
								</div>
						...
						<div class="card-box">
							...
							<div class="widget-box-2">
								<div class="widget-detail-2">
									<span class="badge  pull-left m-t-20  am-round" style="color: #fff; background: #0e90d2;">91% <i class="zmdi zmdi-trending-up"></i> </span>

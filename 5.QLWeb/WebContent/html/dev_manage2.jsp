						...
						<div class="am-u-sm-12 am-u-md-6">
							<div class="am-btn-toolbar">
								<div class="am-btn-group am-btn-group-xs">
									<a href="shop_manage.jsp"><button type="button" ><span class="am-icon-plus" ></span> 新增</button> </a>
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<div class="am-btn-toolbar">
													<div class="am-btn-group am-btn-group-xs">
														<button type="button" class="btn btn-primary" id="myButton4" data-complete-text="Loading finished" onclick="javaScript:window.location.href='../index2.jsp';">选择</button>
														</div>
												</div>
											</td>
										</tr>
